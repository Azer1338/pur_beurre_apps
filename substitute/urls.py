...
urlpatterns = [
    ...
    url(r'^details/(?P<aliment_id>[0-9]+)/$', views.detail_view, name="detail"),
    ...
    url(r'^initialiseDatabase/$', views.initialise_database_view, name="initialiseDatabase"),
    url(r'^clearTable', views.clear_table_view, name="clearTable"),
]
